							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="新建" onclick="deleteRoleByIds();">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/changeRoleById?id=${role.id}" class="btn bg-olive btn-xs">编辑</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="currentPage">
									<c:if test="${pageInfo.pageNum == currentPage}">
										<li class="active"><a href="${pageContext.request.contextPath}/role/findAll?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a></li>
									</c:if>

									<c:if test="${pageInfo.pageNum != currentPage}">
										<li><a href="${pageContext.request.contextPath}/role/findAll?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a></li>
									</c:if>
								</c:forEach>
		...
		<script>
            ...
            function deleteRoleByIds() {
                ...
                if(confirm("确认删除选中的用户吗？")){
                    // alert(ids);
                    location.href = "${pageContext.request.contextPath}/role/deleteUserByIds?ids="+ids;
                }
            }
