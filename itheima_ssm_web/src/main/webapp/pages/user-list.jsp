							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" id="del_btn" title="删除" onclick="deleteUserByIds();">
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUser?id=${user.id}" class="btn bg-olive btn-xs">编辑</a>
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="currentPage">
									<c:if test="${pageInfo.pageNum == currentPage}">
										<li class="active"><a href="${pageContext.request.contextPath}/user/findAll?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a></li>
									</c:if>

									<c:if test="${pageInfo.pageNum != currentPage}">
										<li><a href="${pageContext.request.contextPath}/user/findAll?page=${currentPage}&size=${pageInfo.pageSize}">${currentPage}</a></li>
									</c:if>
								</c:forEach>
		...
		<script>
			...
			function deleteUserByIds() {
                ...
                if(confirm("确认删除选中的用户吗？")){
                    location.href = "${pageContext.request.contextPath}/user/deleteUserByIds?ids="+ids;
                }
            }
