...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<!-- 内容区域 -->
		<form action="${pageContext.request.contextPath}/orders/updateOrdersById?id=${order.id}" method="post">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a3" readonly="readonly" name="orderTime"
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${order.product.departureTimeStr}" name="departureTime"
								>
						</div>
					</div>
					...
					<tbody>
						<c:forEach var="traveller" items="${order.travellers}">
							<tr>
								...
								<td><input type="text" size="10" value="${traveller.name }" name="travellerTypeStr"
									readonly="readonly"></td>
								<td><input type="text" size="10" value="${traveller.sex }" name="sex"
									readonly="readonly"></td>
								<td><input type="text" size="20"
									value="${traveller.phoneNum }" readonly="readonly" name="phoneNum"></td>
								<td><input type="text" size="15"
									value="${traveller.credentialsTypeStr}" readonly="readonly" name="credentialsTypeStr"></td>
								<td><input type="text" size="28"
									value="${traveller.credentialsNum }" readonly="readonly" name="credentialsNum"></td>
							</tr>
						</c:forEach>
					...
					<div class="row data-type">
							...
							<div class="col-md-4 data text">
								<select name="payType">
									...
									<option value="2" ${order.payType==2?"selected":""}>其他</option>
								</select>
							</div>
