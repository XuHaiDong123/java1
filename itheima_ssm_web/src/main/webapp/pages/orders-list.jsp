...
<body class="hold-transition skin-purple sidebar-mini">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" id="del_btn" title="删除" onclick="deleteOrdersByIds();">
											<i class="fa fa-trash-o" ></i> 删除
										</button>
										<button type="button" class="btn btn-default" title="开启">
											<i class="fa fa-check" onclick="openOrderStatus();"></i> 开启
										</button>
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findOrdersById?id=${orders.id}'">详情</button>
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/changeOrderById?id=${orders.id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
								<c:if test="${pageInfo.pageNum == pageNum}">
									<li class="active"><a href="${pageContext.request.contextPath}/orders/findAll?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:if>
								<c:if test="${pageInfo.pageNum != pageNum}">
	...
	<script>
		...
		function deleteOrdersByIds() {
			//alert("...");
			var allId = document.getElementsByName("ids");
			var ids = [];
            ...
            if(confirm("确认删除选中订单吗？")){
                location.href = "${pageContext.request.contextPath}/orders/deleteOrdersByIds?ids="+ids;
			}
        }
